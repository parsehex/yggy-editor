...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst state_1 = __webpack_require__(/*! ./state */ \"./editor/src/state.ts\");\nconst state_2 = __webpack_require__(/*! ../../src/state */ \"./src/state.ts\");\n/** Call `draw()` afterwards */\nfunction goToNext() {\n    const nextHistoryIndex = state_1.default.currentHistoryIndex + 1;\n    if (nextHistoryIndex >= state_1.default.history.length)\n        return;\n    state_2.default.currentDialogueID = state_1.default.history[nextHistoryIndex];\n    state_1.default.currentHistoryIndex++;\n}\nexports.goToNext = goToNext;\n/** Call `draw()` afterwards */\nfunction goToPrev() {\n    const prevHistoryIndex = state_1.default.currentHistoryIndex - 1;\n    if (prevHistoryIndex < 0)\n        return;\n    state_2.default.currentDialogueID = state_1.default.history[prevHistoryIndex];\n    state_1.default.currentHistoryIndex--;\n}\nexports.goToPrev = goToPrev;\n/**\n * Add a dialogue to the history.\n *\n * If not at the end of history then all forward history is cleared.\n *\n * You should `draw()` afterwards.\n */\nfunction push(dialogueID) {\n    if (state_1.default.currentHistoryIndex < state_1.default.history.length - 1) {\n        state_1.default.history.length = state_1.default.currentHistoryIndex + 1;\n    }\n    state_2.default.currentDialogueID = dialogueID;\n    state_1.default.history.push(dialogueID);\n    state_1.default.currentHistoryIndex++;\n}\nexports.push = push;\n\n\n//# sourceURL=webpack:///./editor/src/navigation.ts?");
